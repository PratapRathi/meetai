...
export const meetingsRouter = createTRPCRouter({
  ...
  create: premiumProcedure("meetings").input(meetingsInsertSchema).mutation(async ({ ctx, input }) => {
    const [createdMeeting] = await db
      ...
      .returning();
    // Creating a Stream call and connecting to meeting
